// Package tags implements the public-facing Tags API endpoints.
package tags
...
// ErrNotFound is returned when a tag cannot be located by slug.
var ErrNotFound = errors.New("tags: not found")

// Resource is the public response shape for a single tag.
//
